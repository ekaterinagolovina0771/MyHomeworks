...
# Данные для тестирования работы с JSON, CSV
data = [
    {
...
# Запись данных в CSVфайл
file_path = 'test.csv'
write_csv(file_path, *data)
append_csv(*new_data, file_path=file_path)
print(read_csv(file_path))

# Данные для тестирования работы с TXT
file_path = "test.txt"
data = 'Привет, мир!'
new_data = 'Hi, word!'

write_txt(file_path, data)
append_txt(file_path, new_data)
print(read_txt(file_path))

# Тестирование работычтения файла формата YAML
file_path = 'test.yaml'
