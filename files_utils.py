...
Модуль для работы с файлами различных форматов: JSON, CSV, TXT и YAML
Функции модуля:
- read_json() - чтение данных из JSON-файла
- write_json() - запись данных в JSON-файл
- append_json() - добавление данных в JSON-файл
- read_csv() - чтение данных из CSV-файла
- write_csv() - запись данных в CSV-файл
- append_csv() - добавление данных в CSV-файл
- read_txt() - чтение данных из TXT-файла
- write_txt() - запись данных в TXT-файл
- append_txt() - добавление данных в TXT-файл
- read_yaml() - чтение данных из YAML-файла
"""
